...
class User extends Authenticatable
{
    ...
    public function votes(){
        return $this->belongsToMany(discussion::class, 'votes');
    }
    ...
    public function isAdmin()
    {
        return in_array($this->email, [
            'saurav.lamichhanesaurav@gmail.com',
            'kashyapchapagain@gmail.com',
            'sagarpanth22@gmail.com',
            'wolverineshrestha35@gmail.com'
        ]);
    }
}
