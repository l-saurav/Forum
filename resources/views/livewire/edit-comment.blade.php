        ...
        class="py-4 overflow-hidden transition-all transform bg-white modal rounded-tl-xl rounded-tr-xl sm:max-w-lg sm:w-full">
            ...
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                ...
                <form wire:submit.prevent="updateComment" action="#" method="POST" class="px-4 py-6 space-y-4">
                    <div>
                        <textarea x-ref="editComment" wire:model.defer="body" name="discussion" id="discussion" cols="30" rows="4" class="w-full px-4 py-2 text-sm placeholder-gray-900 bg-gray-100 border-none rounded-xl" placeholder="Enter your comment..." required></textarea>
                        @error('body')
